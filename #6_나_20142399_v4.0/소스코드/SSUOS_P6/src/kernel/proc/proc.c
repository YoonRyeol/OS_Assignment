...
//	palloc_free_one_page(kernel_area, cur_process->stack);
//	palloc_free_one_page(kernel_area, cur_process->pd);
//	palloc_free_one_page(kernel_area, pt);
//	palloc_free_one_page(kernel_area, pt2);
}
